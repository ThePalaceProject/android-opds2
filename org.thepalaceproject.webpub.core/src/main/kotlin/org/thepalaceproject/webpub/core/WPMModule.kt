...
object WPMModule {
  ...
  fun createDeserializers() : SimpleDeserializers {
    return DmJsonRestrictedDeserializers.builder()
      ...
      .allowClass(WPMFacet::class.java)
      .allowClass(WPMFeed::class.java)
      .allowClass(WPMGroup::class.java)
      ...
      .allowClassName("java.util.List<org.thepalaceproject.webpub.core.WPMFacet>")
      .allowClassName("java.util.List<org.thepalaceproject.webpub.core.WPMGroup>")

...
object O2Module {
  ...
  fun createDeserializers() : SimpleDeserializers {
    return DmJsonRestrictedDeserializers.builder()
      ...
      .allowClassName("java.util.List<org.thepalaceproject.webpub.core.O2Catalog>")
      .allowClassName("java.util.List<org.thepalaceproject.webpub.core.O2IndirectAcquisitionTree>")
      .allowClassName("java.util.List<org.thepalaceproject.webpub.core.O2Link>")
      .allowClassName("java.util.List<org.thepalaceproject.webpub.core.O2LinkDeserializer\$O2LinkRaw>")
      .allowClassName("java.util.List<org.thepalaceproject.webpub.core.O2NavigationLink>")
      .allowClassName("java.util.List<org.thepalaceproject.webpub.core.O2Publication>")
      .allowClassName("java.util.List<org.thepalaceproject.webpub.core.O2Subject>")
